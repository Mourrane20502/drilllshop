    ...
    <>
      <div
        className={`${
          isScrolling
            ? "hidden"
            : "bg-black   dark:bg-white  dark:text-black fromLeft text-white"
      ...
      <header
        className={`${
          isScrolling
            ? "shadow-lg py-4 dark:border-b dark:border-white"
            : "shadow-md py-6"
      ...
      >
        <nav className="flex items-center justify-around w-full">
          ...
          <div className="flex space-x-6 max-md:hidden w-[30%]">
            <Link
              href="/"
              className="text-xl dark:text-white hover:scale-105 transition-all duration-300 ease-in-out"
            >
              Home
            </Link>
            <Link
            ...
            <Link
              className="text-xl hover:scale-105 dark:text-white  transition-all duration-300 ease-in-out"
              href="#contact"
            >
              Contact
            </Link>
          ...
          {isMobile ? (
            <X
              ...
              className="w-10 h-10 hidden max-md:block"
            />
          ) : (
            <Menu
              onClick={toggleMobile}
              className="w-10 h-10 dark:text-white hidden max-md:block"
            />
          )}
        </nav>
      </header>
