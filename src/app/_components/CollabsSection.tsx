  ...
  return (
    <section className="py-20 bg-black dark:bg-white dark:shadow-lg text-white mb-5">
      <div className="container mx-auto text-center mb-12">
        <h2 className="text-5xl font-bold dark:text-black max-md:text-2xl">Our Amazing Collaborators</h2>
      ...
      <div className="overflow-hidden">
        <div className="collabs-container items-center justify-center max-md:items-baseline flex animate-scroll gap-6">
          {mockCollabData.map((collab) => (
            <div key={collab.id} className="flex flex-col justify-center items-center w-32 mx-4">
              <Image
                src={collab.imageUrl}
                alt={collab.name}
